function User(userName) {
    ...
    this.sendMessage = function(sendMsg) {
        this.followers.forEach((someone)=> {
            someone.getMessage(someone.theNameOfTheUser+ ' got a message from ' +this.theNameOfTheUser+ ': '+ sendMsg);
        })
    }

    this.getMessage = function(getMsg) {
            console.log(getMsg);
    }
